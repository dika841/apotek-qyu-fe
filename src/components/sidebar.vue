...
<template>
    <aside class="w-64 h-full bg-white" aria-label="Sidebar">
        <div class="p-4 m-4 rounded bg-blue-300">
            <a href="index.html" class="text-white px-12 text-3xl font-normal items-center ">Admin</a>
        </div>
      <hr>
   <div class="overflow-y-auto py-4 px-3 rounded h-150 bg-white ">
      <ul class="space-y-2">
         <li>
